...
Modélisation, parcours d'arbre et algorithme de Dijkstra

Branche : `tp/ue0-04-graphes`
...
cd cours_td_public
git switch tp/ue0-04-graphes
```

Si vous avez déjà le dépôt, `git fetch origin` puis `git switch tp/ue0-04-graphes`.
