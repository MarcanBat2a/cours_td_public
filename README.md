...
Notion de complexité, calcul et optimisation

Branche : `tp/ue0-03-complexite`
...
cd cours_td_public
git switch tp/ue0-03-complexite
```

Si vous avez déjà le dépôt, `git fetch origin` puis `git switch tp/ue0-03-complexite`.
...
- `td-tris.md` - TD facultatif : cinq tris chronométrés sur le même jeu de données, à faire après le TD 4
