# Chapitre 4 - Aussi écouté

**UE 1 - Persistance & Systèmes Distribués (NoSQL)** · TD et matériel de séance
Graphes avec Neo4j, colonnes avec Cassandra

Branche : `tp/ue1-04-graphes-colonnes`
...
cd cours_td_public
git switch tp/ue1-04-graphes-colonnes
```

Si vous avez déjà le dépôt, `git fetch origin` puis `git switch tp/ue1-04-graphes-colonnes`.
