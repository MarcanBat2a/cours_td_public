# Chapitre 5 - Ondine passe l'Atlantique

**UE 1 - Persistance & Systèmes Distribués (NoSQL)** · TD et matériel de séance
Stratégies de distribution : couper, choisir la clé, trois régions

Branche : `tp/ue1-05-distribution`
...
cd cours_td_public
git switch tp/ue1-05-distribution
```

Si vous avez déjà le dépôt, `git fetch origin` puis `git switch tp/ue1-05-distribution`.
