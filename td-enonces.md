...
>
> **Les missions** se font dans l'ordre. Le symbole ★ marque la
...
> Docker, rejoignez un voisin le temps de la séance.
...
**Partie A sur papier, partie B sur machine**

## Partie A - Quatre incidents *(papier)*
...
## Partie B - Le chronomètre *(machine)*
...
## Étape 2 - Le prix de la majorité
...
**En groupes de trois · débat, puis papier**

## Partie A - Six affirmations
